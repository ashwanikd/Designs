...
public class LogarithmicSpiral{
    ...
    LogarithmicSpiral(){
        ...
        frame = new Frame("Logarithmic Spiral");
    ...
    class EventListener implements GLEventListener{
        ...
        boolean addPoint(){
            ...
            l.add(new Point(r*Math.exp(b*theta)*Math.cos(theta)/100,r*Math.exp(b*theta)*Math.sin(theta)/100,0));
            //l.add(new Point(-1*r*Math.exp(b*theta)*Math.cos(theta)/100,-1*r*Math.exp(b*theta)*Math.sin(theta)/100,0));
            return true;
        }
