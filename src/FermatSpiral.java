...
public class FermatSpiral{
    ...
    class EventListener implements GLEventListener{
        ...
        boolean addPoint(){
            ...
            l.add(new Point(r*Math.sqrt(theta)*Math.cos(theta)/100,r*Math.sqrt(theta)*Math.sin(theta)/100,0));
            l.add(new Point(-1*r*Math.sqrt(theta)*Math.cos(theta)/100,-1*r*Math.sqrt(theta)*Math.sin(theta)/100,0));
            return true;
        }
